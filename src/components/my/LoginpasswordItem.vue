...
.kaif{
    text-align: center; font-size: 5vw; color: gray; margin-top: 10vw;
}
/*顶部*/
#nav{
...
.liu p{
    font-size: 4.5vw; margin-top: 5vw;
}
input{
    width: 80%; height: 15vw; margin-top: 5vw; font-size: 5vw;
}
